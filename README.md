...
Maintainers may use generative AI tools as assistants while working on xdg-desktop-portal-singularity. Non-trivial assisted commits disclose the tool, model, and scope of the work.
